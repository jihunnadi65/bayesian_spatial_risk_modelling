...
```{r}
# inspect multi-collinearity before progresssing with above variables
# none of the variables have correlations above 0.7 or below -0.7, so we can move forward with these variables
cor(X)
```
